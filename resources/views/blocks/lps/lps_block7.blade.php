<div class="container my-5" id="productos">
  ...
  <section>
    ...
    <h3 class="font-weight-bold text-center dark-grey-text pb-2">Nuestro Productos</h3>
    <hr class="w-header my-4">
    <p class="lead text-center text-muted pt-2 mb-5">Todos nuestros productos estan creados con las tecnologias actuales del mercado.</p>
    ...
    <div class="row">
      ...
      <div class="col-12">
        ...
        <ul class="nav md-pills flex-center flex-wrap mx-0" role="tablist">
          <li class="nav-item">
            <a class="nav-link active font-weight-bold text-uppercase" data-toggle="tab" href="#panel31" role="tab">Softwares</a>
          </li>
          <li class="nav-item">
            <a class="nav-link font-weight-bold text-uppercase" data-toggle="tab" href="#panel32" role="tab"></a>
          </li>
          <li class="nav-item">
            <a class="nav-link font-weight-bold text-uppercase" data-toggle="tab" href="#panel33" role="tab"></a>
          </li>
        </ul>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-4">
            ...
            <a class="card hoverable mb-4" data-toggle="modal" data-target="#basicExampleModal">
              ...
              <!-- Card image -->
              <img class="card-img" src="https://mystorage.loginweb.dev/storage/Projects/loginweb/appxi.png"  alt="Card image cap">

              <!-- Card content -->
              <div class="card-body">

                <h5 class="my-3">Appxi</h5>
                <p class="card-text text-uppercase mb-3">Software para servcio de taxi en general</p>
            ...
            <a class="card hoverable mb-4" data-toggle="modal" data-target="#basicExampleModal">
              ...
              <!-- Card image -->
              <img class="card-img-top" src="https://mystorage.loginweb.dev/storage/Projects/loginweb/bimgo.png" alt="Card image cap">

              <!-- Card content -->
              <div class="card-body">

                <h5 class="my-3">BimGo</h5>
                <p class="card-text text-uppercase mb-3">Software para comercio electronico en General</p>
          ...
          <div class="col-md-6 col-lg-4">
            ...
            <a class="card hoverable mb-4" data-toggle="modal" data-target="#basicExampleModal">
              ...
              <!-- Card image -->
              <img class="card-img-top" src="https://mystorage.loginweb.dev/storage/Projects/loginweb/yimbo.png" alt="Card image cap">

              <!-- Card content -->
              <div class="card-body">

                <h5 class="my-3">YimBo</h5>
                <p class="card-text text-uppercase mb-3">software para venta de comida y delivery</p>
            ...
            <a class="card hoverable mb-4" data-toggle="modal" data-target="#basicExampleModal">
              ...
              <!-- Card image -->
              <img class="card-img-top" src="https://mystorage.loginweb.dev/storage/Projects/loginweb/medicweb.png" alt="Card image cap">

              <!-- Card content -->
              <div class="card-body">

                <h5 class="my-3">Medicweb</h5>
                <p class="card-text text-uppercase mb-3">software para la gestion y administracion de Consultorios medicos virtuales</p>
          ...
          <div class="col-md-6 col-lg-4">
            ...
            <a class="card hoverable mb-4" data-toggle="modal" data-target="#basicExampleModal">
              ...
              <!-- Card image -->
              <img class="card-img-top" src="https://mystorage.loginweb.dev/storage/Projects/loginweb/histream.png" alt="Card image cap">

              <!-- Card content -->
              <div class="card-body">

                <h5 class="my-3">hiStream</h5>
                <p class="card-text text-uppercase mb-3">software para la gestion de video conferencias</p>
            ...
            <a class="card hoverable mb-4" data-toggle="modal" data-target="#basicExampleModal">
              ...
              <!-- Card image -->
              <img class="card-img-top" src="https://mystorage.loginweb.dev/storage/Projects/loginweb/migerente.png" alt="Card image cap">

              <!-- Card content -->
              <div class="card-body">

                <h5 class="my-3">MiGerente</h5>
                <p class="card-text text-uppercase mb-3">Software administrativo & contable, TODO EN UNO PARA EMPRESAS</p>
